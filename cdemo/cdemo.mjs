...
import { BarGraph } from "./components/bar_graph/bar_graph.mjs";
import { BubblePack } from "./components/bubble_pack/bubble_pack.mjs";
...
export const cdemo = {
	...
	barPlot: (obj) => barPlot(obj),
	bubblePack: (obj) => bubblePack(obj)
};

export function bubblePack(obj) {
	return new BubblePack(obj).render();
}

export function barPlot(obj) {
	return new BarGraph(obj).render();
}
